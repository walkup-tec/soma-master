...
export const Route = createFileRoute("/app/chat")({
  loader: async () => {
    ...
    return { bootstrap, attendanceStatuses: settings.attendanceStatuses };
  },
  staleTime: 5_000,
  component: ChatPage,
});
...
function ChatPage() {
  const { bootstrap, attendanceStatuses } = Route.useLoaderData();
  return <ChatInboxScreen bootstrap={bootstrap} attendanceStatuses={attendanceStatuses} />;
}
