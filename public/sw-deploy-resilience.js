 ...
 * do Redeploy do gestao-interno (este host não é o WABA).
 */
const CACHE_SHELL = "soma-deploy-shell-v8";
const SW_VERSION = "v8";
    ...
    (function () {
      ...
      async function probe() {
        ...
        try {
          ...
          if (res.ok && data && data.ok === true && String(data.service || "") === "soma-gestao-interno") {
